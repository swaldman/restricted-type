...
object RestrictedShort {
  ...
  object AnyShort extends RestrictedShort[AnyShort] {
    ...
    override protected def create( value : Short ) = new AnyShort( value ); 
  }
  class AnyShort private ( val widen : Short ) extends AnyVal with RestrictedType.Element[Short];

  object UnsignedShort extends Unsigned[UnsignedShort] {
    override protected def create( value : Short ) = new UnsignedShort( value ); 
  }
